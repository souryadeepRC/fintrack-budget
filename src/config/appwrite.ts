...
const COLLECTIONS = {
  ...
  NOTIFICATIONS: process.env.NEXT_PUBLIC_APPWRITE_NOTIFICATION_COLLECTION_ID || 'notifications',
  EXPENSE_CATEGORIES:
...
export { APPWRITE_ENDPOINT, APPWRITE_PROJECT_ID, COLLECTIONS,DATABASE_ID };
